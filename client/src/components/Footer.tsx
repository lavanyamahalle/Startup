      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-6">Transforming health and managing weight naturally through the power of food as medicine and energizing physical activity.</p>
            <div className="flex space-x-4">
              <a 
                href={socialLinks.whatsapp}
                target="_blank"
                rel="noopener noreferrer" 
                className="bg-white/10 hover:bg-white/20 w-10 h-10 rounded-full flex items-center justify-center text-white hover:text-[#D2B48C] transition-all duration-300 hover-card" 
                aria-label="WhatsApp"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="hover:text-[#D2B48C] transition flex items-center">
                  <i className="fas fa-chevron-right mr-2 text-xs text-[#D2B48C]"></i>
                  <span>Home</span>
                </Link>
              </li>
              <li>
                <Link href="/about" className="hover:text-[#D2B48C] transition flex items-center">
                  <i className="fas fa-chevron-right mr-2 text-xs text-[#D2B48C]"></i>
                  <span>About Dt. Sakshi</span>
                </Link>
              </li>
              <li>
                <Link href="#zumba" className="hover:text-[#D2B48C] transition flex items-center">
                  <i className="fas fa-chevron-right mr-2 text-xs text-[#D2B48C]"></i>
                  <span>Zumba Classes</span>
                </Link>
              </li>
              <li>
                <Link href="#diet-consultation" className="hover:text-[#D2B48C] transition flex items-center">
                  <i className="fas fa-chevron-right mr-2 text-xs text-[#D2B48C]"></i>
                  <span>Diet Consultation</span>
                </Link>
              </li>
              <li>
                <Link href="/programs" className="hover:text-[#D2B48C] transition flex items-center">
                  <i className="fas fa-chevron-right mr-2 text-xs text-[#D2B48C]"></i>
                  <span>Programs</span>
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-[#D2B48C] transition flex items-center">
                  <i className="fas fa-chevron-right mr-2 text-xs text-[#D2B48C]"></i>
        ...
        <div className="border-t border-white/20 mt-12 pt-6 text-center">
          ...
          <div className="mt-2">
            <span className="text-sm text-white/60">Developed with ❤️ for a healthier world</span>
          </div>
        </div>
      </div>
    </footer>
