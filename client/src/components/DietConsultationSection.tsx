...
export default function DietConsultationSection() {
  ...
  const handleGeneralConsult = () => {
    const message = encodeURIComponent(
      "Hi Sustenance Wellness! I'd like to schedule a personalized diet consultation. Can you help me with this?",
    );
  ...
  const handleWeightManagement = () => {
    const message = encodeURIComponent(
      "Hi Sustenance Wellness! I'm interested in your Weight Management program. Can you provide more details?",
    );
    window.open(`https://wa.me/7264072630?text=${message}`, "_blank");
  };
  ...
  const handleMedicalNutrition = () => {
    const message = encodeURIComponent(
      "Hi Sustenance Wellness! I'm interested in your Medical Nutrition plan. Can you provide more details?",
    );
    window.open(`https://wa.me/7264072630?text=${message}`, "_blank");
  };
  ...
  const handleSportsNutrition = () => {
    const message = encodeURIComponent(
      "Hi Sustenance Wellness! I'm interested in your Sports Nutrition plan. Can you provide more details?",
    );
    window.open(`https://wa.me/7264072630?text=${message}`, "_blank");
  };
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0 text-white">
            ...
            <p className="text-base sm:text-lg mb-6 sm:mb-8 leading-relaxed">
              Achieve your health and wellness goals with customized nutrition
              plans designed specifically for your body type, lifestyle, and
              preferences by our expert nutritionist.
            </p>
            ...
            <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              ...
              <div className="flex items-center">
                ...
                <p className="font-medium text-sm sm:text-base">
                  24/7 WhatsApp support for guidance and questions
                </p>
              </div>
            </div>
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            ...
            <p className="text-gray-100 text-sm sm:text-base">
              Scientifically-backed programs for weight loss, gain, or
              maintenance based on your body type.
            </p>
          ...
          >
            ...
            <p className="text-gray-100 text-sm sm:text-base">
              Specialized therapeutic diets for managing diabetes, thyroid
              disorders, PCOS, and other health conditions.
            </p>
            <div className="mt-3 sm:mt-4 inline-flex items-center text-[#D2B48C]">
              <span className="text-xs sm:text-sm">Contact on WhatsApp</span>
              <i className="fab fa-whatsapp ml-2"></i>
          ...
          >
            ...
            <p className="text-gray-100 text-sm sm:text-base">
              Performance-enhancing nutrition plans for athletes and fitness
              enthusiasts to maximize results.
            </p>
            <div className="mt-3 sm:mt-4 inline-flex items-center text-[#D2B48C]">
              <span className="text-xs sm:text-sm">Contact on WhatsApp</span>
              <i className="fab fa-whatsapp ml-2"></i>
